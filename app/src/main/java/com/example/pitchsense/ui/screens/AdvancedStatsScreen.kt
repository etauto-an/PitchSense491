        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text("Direct Statcast Metrics", style = MaterialTheme.typography.titleLarge)
                    Text(
                        batter,
                        style = MaterialTheme.typography.bodyMedium,
                        color = Color.Gray
            ...
            Card(
                ...
                Column(
                    ...
                    Text("Whiff by Pitch Type", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
